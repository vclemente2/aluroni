...
import massaUm from "../../assets/images/massa1.png";
import massaDois from "../../assets/images/massa2.png";
  ...
  return (
    <section>
      ...
      <div className={styles.imagens}>
        <img src={massaUm} alt="Imagem de massa" />
        <img src={massaDois} alt="Imagem de massa" />
      </div>
    </section>
  );
}
